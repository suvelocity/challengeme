...
const challengesMock = require('../../../../server/_tests_/mocks/challenges');
const labelsMock = require('../../../../server/_tests_/mocks/labels');
const usersMock = require('../../../../server/_tests_/mocks/users');
const submissionsMock = require('../../../../server/_tests_/mocks/submissions');
