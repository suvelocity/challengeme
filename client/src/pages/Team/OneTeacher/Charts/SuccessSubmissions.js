...
function SuccessSubmissions({ members }) {
    ...
    return (<div className="success-chart">
        <h2>Teams Success Submissions</h2>
        <BarChart width={730} height={250} data={members.map(user => {
            return { username: user.username, success: user.Submissions[0].userSuccessSubmission }
        })}>
