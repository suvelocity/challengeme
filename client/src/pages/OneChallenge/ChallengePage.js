        ...
        return (
            <div style={{ textAlign: "center" }}>
                <p>
                    ...
                    You tried to solved this challenge on {generateTime(submissionStatus.createdAt)}{" "}
                    <br /> You can try to submit again
                </p>
            </div>
        );
    };
                ...
                <div className="one-challenge-challenge-container">
                    ...
                    <div className="one-challenge-info-container">
                                ...
                                {challenge.Labels &&
                                    challenge.Labels.map((label) => (
                                        <Link
                                            ...
                                            to="/"
                                            onClick={() =>
                                                filteredLabels.setFilteredLabels([label.id])
                                            }
                                        >
                        ...
                        <div className="one-challenge-author-uploaded-updated">
                            ...
                            <div className="one-challenge-updated-at">Updated At: {date || ""}</div>
                        </div>
