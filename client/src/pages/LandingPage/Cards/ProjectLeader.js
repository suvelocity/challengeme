...
export default function SimpleCard({ icon, name, rule, content, github, linkedin }) {
    return (
        <Card className='Landing-page-Project-Leaders-Root'>
            <CardContent>
                <IconButton href={`https://www.linkedin.com/in/${linkedin}`} target="_blank" className='Landing-page-Project-Leaders-Icon'>  <img className='Landing-page-Project-Leaders-Image' src={icon} /></IconButton>
