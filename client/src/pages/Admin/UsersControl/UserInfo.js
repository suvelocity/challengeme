...
export default function UserInfo({ userInfo, fetchUserInfo, setUserInfo, editMode, id, editedUserInfo, setEditedUserInfo, getAllUsers }) {
        ...
        <div className="generic-page-admin">
            <div className='user-data-header'>
                ...
                <div className='user-data-permission'>
                    <h2>Permission: {userInfo.permission}</h2>
            ...
            <div className="user-page-admin">
                <div className="user-info-container-admin">
                    <TextField
                        name="id"
                        onChange={editing} className={classes.info}
