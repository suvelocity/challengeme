    ...
    const body = (
        <div style={modalStyle} className={classes.paper}>
            ...
            <div id="simple-modal-description">
                <Input onChange={(event) => setNewToken(event.target.value)} placeholder='Insert Token...' /><br/><br/>
                <Input onChange={(event) => setNewTokeGgitAccount(event.target.value)} placeholder='Insert Github Account...' /><br/><br/>
                <Input onChange={(event) => setNewTokeActionslimit(event.target.value)} placeholder='Insert Action Limit...' /><br/><br/>
            </div>
            <Button
                variant="contained"
                color="primary"
