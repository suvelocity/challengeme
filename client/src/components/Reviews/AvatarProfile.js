  ...
  return (
    ...
    >
      ...
      <circle
        ...
        opacity="0.5"
      ></circle>
      <circle cx="349.68" cy="346.77" r="341.64" fill="#f5f5f5"></circle>
      <path
        fill="#6c63ff"
      ...
      ></path>
      <circle cx="346.37" cy="339.57" r="164.9" fill="#333"></circle>
      <path
      ...
      <path
        ...
        transform="translate(-251 -101)"
      ></path>
      <circle cx="346.37" cy="372.44" r="151.45" fill="#fdb797"></circle>
      <path
